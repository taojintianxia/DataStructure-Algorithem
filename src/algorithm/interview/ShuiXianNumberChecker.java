...
public class ShuiXianNumberChecker {

	/**
	 * 水仙花数是指一个N位正整数（N>=3），它的每个位上的数字的N次幂之和等于它本身。例 如：153 = 1的三次方 + 5的三次方 + 3的三次方。 本题要求编写程序,计算所有N位水仙花数。
	 * 
	...
	public static void main(String... args) {
		ShuiXianNumberChecker shuixianChecker = new ShuiXianNumberChecker();
		shuixianChecker.printShuiXian(3);
	}
	...
	private boolean isAShuiXian(double number) {
		int targetNumber = 0;
