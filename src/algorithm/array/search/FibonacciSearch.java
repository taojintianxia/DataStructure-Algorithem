...
public class FibonacciSearch {
    ...
    public static void main(String... arg) throws Exception {
        ...
        System.out.println("the corresponding value for index " + position
                + " is : " + sourceArray[position]);
    }

    public static int fibonacciSearch(int[] fibonacciArray, int[] sourceArray,
            int key) {
